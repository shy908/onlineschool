...
const CodeOfConduct = () => {
  return (
    <div className="w-full max-w-3xl mx-auto font-sans text-gray-800 p-6">
      {/* Header Section */}
      <div className="mb-6 text-center">
        <h2 className="text-4xl font-bold text-[#1f5256] mb-4">
          Code of Conduct
        </h2>
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-2xl font-semibold text-[#1f5256] mb-4">1. Respect and Integrity</h3>
        ...
        <div>
          <h3 className="text-2xl font-semibold text-[#1f5256] mb-4">2. Academic Integrity</h3>
          <p className="text-lg text-gray-700">
        ...
        <div>
          <h3 className="text-2xl font-semibold text-[#1f5256] mb-4">3. Attendance and Participation</h3>
          <p className="text-lg text-gray-700">
        ...
        <div>
          <h3 className="text-2xl font-semibold text-[#1f5256] mb-4">4. Respect for Learning Materials</h3>
          <p className="text-lg text-gray-700">
        ...
        <div>
          <h3 className="text-2xl font-semibold text-[#1f5256] mb-4">5. Communication Etiquette</h3>
          <p className="text-lg text-gray-700">
        ...
        <div>
          <h3 className="text-2xl font-semibold text-[#1f5256] mb-4">6. Safe Online Behavior</h3>
          <p className="text-lg text-gray-700">
        ...
        <div>
          <h3 className="text-2xl font-semibold text-[#1f5256] mb-4">7. Respect for Technology and Resources</h3>
          <p className="text-lg text-gray-700">
        ...
        <div>
          <h3 className="text-2xl font-semibold text-[#1f5256] mb-4">8. Commitment to Continuous Improvement</h3>
          <p className="text-lg text-gray-700">
        ...
        <div>
          <h3 className="text-2xl font-semibold text-[#1f5256] mb-4">9. Consequences of Violating the Code of Conduct</h3>
          <p className="text-lg text-gray-700">
